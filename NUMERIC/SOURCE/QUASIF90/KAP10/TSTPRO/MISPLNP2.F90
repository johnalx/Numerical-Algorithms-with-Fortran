...
!                    ISPLNP, ISPLNK, SPTAB                             *
!----------------------------------------------------------------------*
!     required subroutines    :  ISPLNP, ISPLNK, SPTAB,                *
!                                TRDIG,  TRDIGP, TRDIGS                *
!----------------------------------------------------------------------*
!                                                                      *
!     We test a non parametric interpolating cubic spline with not a   *
!     node condition.                                                  *
!                                                                      *
...
![   I        A(I)           B(I)           C(I)           D(I)       ]*
![  --------------------------------------------------------------    ]*
![   0    .000000D+00    .503922D+01   -.315294D+01    .454902D+00    ]*
![   1    .200000D+01   -.134902D+01   -.110588D+01    .454902D+00    ]*
![   2    .000000D+00   -.238039D+01    .258823D+00    .300655D-01    ]*
![   3   -.400000D+01   -.156845D-01    .529413D+00   -.812556D-01    ]*
![   4   -.200000D+01    .110784D+01   -.800044D-01    .130430D-01    ]*
![   5    .000000D+00    .944335D+00   -.174634D-02    .147893D-01    ]*
![   6    .200000D+01    .111482D+01    .869897D-01   -.851674D-01    ]*
![   7    .400000D+01   -.471186D-01   -.551766D+00    .410093D-01    ]*
![   8    .000000D+00   -.225046D+01   -.182683D+00    .433147D+00    ]*
![   9   -.200000D+01   -.131639D+01    .111676D+01    .433147D+00    ]*
!                                                                      *
