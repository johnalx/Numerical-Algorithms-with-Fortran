      SUBROUTINE AKIMA2 (N, XN, FN, NK, BETA, B, C, D, ISWTCH, HELP,    &
      IERR)                                                             
!                                                                       
!*****************************************************************      
!                                                                *      
!  The program AKIMA2 computes the coefficients  B(I), C(I) and  *      
!  D(I) for I=0, ... , N-1 of an interpolating cubic AKIMA       *      
!  spline, which can be either periodic or nonperiodic.          *      
!  The computation of slopes in AKIMA2 follows the suggestion of *      
!  R. Wodicka, see the literature quote below.                   *      
...
!*****************************************************************      
!                                                                *      
! Literature : R. Wodicka,                                       *      
!              Erg„nzungen zu Akima's Steigungsformel,           *      
!              Mitteilungen aus dem Mathematischen Seminar       *      
!              Giessen, Heft 203, 1991                           *      
!                                                                *      
!*****************************************************************      
!                                                                       
!     Declarations                                                      
...
!                                                                       
    ...
    5 FMACHP = 0.5D0 * FMACHP 
      ...
      EPS = 4.0D0 * FMACHP 
!                                                                       
!     Compute the sizes of subintervals and store in the first          
...
!                                                                       
   ...
   10 END DO 
!                                                                       
!     Compute the secant slopes and store in the second column of HELP  
!                                                                       
      DO 20, I = 0, N - 1 
         HELP (I, 2) = (FN (I + 1) - FN (I) ) / HELP (I, 1) 
   20 END DO 
!                                                                       
!     Find the magnitudes of the slope differences and store in column 3
!                                                                       
      DO 30, I = 0, N - 2 
...
!                                                                       
   ...
   40       END DO 
!                                                                       
!     Shift data associated with points I to N-1                        
!                                                                       
            DO 50, J = N - 1, I, - 1 
               HELP (J + 1, 1) = HELP (J, 1) 
               HELP (J + 1, 2) = HELP (J, 2) 
   50       END DO 
!                                                                       
!     Shift slope difference data for points I to IMAX                  
!                                                                       
            DO 60, J = IMAX, I, - 1 
               HELP (J + 1, 3) = HELP (J, 3) 
   60       END DO 
!                                                                       
!     Form additional points I and I+1                                  
!                                                                       
            XL = HELP (I - 1, 1) 
            XR = HELP (I + 1, 1) 
            XB = BETA * DMIN1 (XL, XR) 
...
!                                                                       
         ...
         ENDIF 
!                                                                       
!     Set index for the subsequent point                                
!                                                                       
         I = I + 1 
      ...
      IF (ISWTCH.EQ.1) THEN 
!                                                                       
!     In the periodic case, assign additional slopes                    
!                                                                       
         HELP ( - 2, 2) = HELP (N - 2, 2) 
         HELP ( - 1, 2) = HELP (N - 1, 2) 
         HELP (N, 2) = HELP (0, 2) 
      ...
      ELSE 
!                                                                       
!     In the nonperiodic case, assign additional slopes as well         
!                                                                       
...
!                                                                       
!     Compute the left and right handed slopes at points 0 to N-1       
...
!                                                                       
   ...
   90 END DO 
!                                                                       
!     Compute the left handed slope at point N                          
!                                                                       
      XL = HELP (N - 2, 3) 
      XR = HELP (N, 3) 
      IF (XL + XR.GT.EPS) THEN 
