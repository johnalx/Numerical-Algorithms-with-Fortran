...
!*****************************************************************      
!                                                                *      
!     Test program for the subroutines PR2TRA and APPRT2         *      
!----------------------------------------------------------------*      
!  required subroutiens     : FCT,PR2TRA,ALPHA2,GAMMA2,NEXT2,    *      
!                             APPRT2,CEPSPM,ZSPMMK,PCOSOL,       *      
...
!  We compute the coefficients of the spline function via PR2TRA *      
!  for various derivative orders and use APPRT2 to interpolate   *      
...
!..                                                                     
!..   loop to compute values for various derivative orders              
!..                                                                     
      DO 60 M = 2, MMAX 
!..                                                                     
!..   create nodes                                                      
...
!..                                                                     
         NX = K 
!..                                                                     
!..   initialize intermediate values, where we shall compare            
!..   the result                                                        
!..                                                                     
         H = 0.2D-1 
         K = 0 
...
!..                                                                     
         ...
         DO 50 I = 1, K 
            ...
            CALL APPRT2 (XHILF, YHILF, NX, M, TX, TY, TC, Z, XQUER,     &
            YQUER, R)                                                   
!..                                                                     
!..   compute error                                                     
!..                                                                     
