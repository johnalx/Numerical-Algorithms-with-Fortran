...
! formula RKV6(5)9A (method of Verner).                          *      
!                                                                *      
!                                                                *      
! INPUT PARAMETERS:                                              *      
! =================                                              *      
...
!                                                                       
      ...
      COEFF (6, 2) = 1.9662371D7 / 5.1149376D7 + 441.281D3 /            &
      1.2787344D7 * H                                                   
      COEFF (7, 2) = - 15.4207593D7 / 36.9412160D7 - 182.9424339D7 /    &
      1154.4130000D7 * H                                                
      COEFF (8, 2) = 7059.4945601D7 / 2140.6013856D7 + 2147.3424323D7 / &
      2140.6013856D7 * H                                                
      ...
      COEFF (6, 4) = - 3.786045D6 / 5.683264D6 - 2.52663D5 / 7.10408D5 *&
      H                                                                 
      COEFF (7, 4) = 265.9895739D7 / 184.7060800D7 + 65.3855409D7 /     &
      115.4413000D7 * H                                                 
      COEFF (8, 4) = - 79.4525145D7 / 8.8090592D7 - 24.9156075D7 /      &
      8.8090592D7 * H                                                   
      COEFF (5, 5) = 12.555D3 / 16.384D3 + 2349.0D0 / 8192.0D0 * H 
      COEFF (6, 5) = 157.0556745D7 / 182.1486112D7 + 29.0041461D7 /     &
      91.0743056D7 * H                                                  
      ...
      COEFF (7, 6) = 15392.0585664D7 / 9249.7341625D7 + 31106.6673408D7 &
      / 46248.6708125D7 * H                                             
      COEFF (8, 6) = ( - 1596419.6472448D7 - 503942.9245312D7 * H)      &
      / 128636.7645159D7                                                
      COEFF (9, 6) = - 1.245184D6 / 1.090341D6 + 9.699328D6 /           &
      1.6355115D7 * H                                                   
...
!                                                                       
      ...
      COEFF (2, 7) = - 1.245184D6 / 1.090341D6 + 9.699328D6 /           &
      1.6355115D7 * H                                                   
